...
namespace App1
{
    ...
    public class History : Activity
    {
        ...
        {
            var json = await client.GetStringAsync("http://192.168.0.78:63835/api/eventsmois");
        ...
        public async void Year(HttpClient client, string Email, string password)
        {
            ...
            var json = await client.GetStringAsync("http://192.168.0.78:63835/api/eventsyear");
            var taskModels = JsonConvert.DeserializeObject<List<Event>>(json);
        ...
        {
            var json = await client.GetStringAsync("http://192.168.0.78:63835/api/eventstmois");
            var taskModels = JsonConvert.DeserializeObject<List<Event>>(json);
